...
[**Report a vulnerability**](https://github.com/hassio-addons/app-foldingathome/security/advisories/new)
...
- Issues in the Folding@home client itself; please report those directly to
  the
  [Folding@home project](https://github.com/FoldingAtHome/fah-client-bastet/security/policy).
...
- Exposure of the app to untrusted networks as a result of the user's own
  configuration, such as publishing the client's API port.

## Scope

This security policy covers the Folding@home Home Assistant app published from
